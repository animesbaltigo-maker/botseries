...
VIDEO_DOWNLOAD_QUEUE_LIMIT = _env_int("VIDEO_DOWNLOAD_QUEUE_LIMIT", 2000)
VIDEO_DOWNLOAD_WORKERS = _env_int("VIDEO_DOWNLOAD_WORKERS", 3)
...
VIDEO_PRECACHE_TITLES = os.getenv("VIDEO_PRECACHE_TITLES", "the boys").strip()
VIDEO_PRECACHE_EPISODES_PER_TITLE = _env_int("VIDEO_PRECACHE_EPISODES_PER_TITLE", 3)
VIDEO_PRECACHE_INTERVAL_SECONDS = _env_int("VIDEO_PRECACHE_INTERVAL_SECONDS", 3600)
VIDEO_PRECACHE_FIRST_DELAY_SECONDS = _env_int("VIDEO_PRECACHE_FIRST_DELAY_SECONDS", 300)
